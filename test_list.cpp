...
{
public:
    bool operator()(int value) const // takes in an int to see if the value is odd
    {
        return value % 2 != 0;
    }
};
...
{
public:
    bool operator()(const std::string &str) const // takes in a const reference and returns if the string is longer than 5
    {
        return str.length() > 5;
    }
};
